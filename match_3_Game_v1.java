...
public class match_3_Game_v1 extends JPanel implements Runnable, MouseListener {

    final int WIDTH = 740;
    final int HEIGHT = 480;
    public static int loopnum = 250;
    ...
    public void draw() {
        ...
        g2.drawImage(Rage, 512, 422, 100, 11, null);   //variable0-216:216(length)
        BufferedImage ragee = zoomOutImage(gems.getSubimage(5 * 49, 0, 49, 49), 30, 30);
        g2.drawImage(ragee, 602,412, null);  //(x:502-712,y:412)
